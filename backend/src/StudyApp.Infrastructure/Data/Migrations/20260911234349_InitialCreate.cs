        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotebookPages_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudySets_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThinkingBreakdownJson = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SourceDocuments_StudySets_StudySetId",
                        column: x => x.StudySetId,
                        principalTable: "StudySets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestSessions_StudySets_StudySetId",
                        column: x => x.StudySetId,
                        principalTable: "StudySets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistractorRationale = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionRubrics_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserSubmittedAnswer = table.Column<string>(type: "text", nullable: false),
                    IsCorrect = table.Column<bool>(type: "boolean", nullable: false),
                    PartialScore = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionAnswers_TestSessions_TestSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotebookPages_CourseId",
                table: "NotebookPages",
                column: "CourseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionRubrics_QuestionId",
                table: "QuestionRubrics",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAnswers_TestSessionId",
                table: "SessionAnswers",
                column: "TestSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_SourceDocuments_StudySetId",
                table: "SourceDocuments",
                column: "StudySetId");

            migrationBuilder.CreateIndex(
                name: "IX_StudySets_CourseId",
                table: "StudySets",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_TestSessions_StudySetId",
                table: "TestSessions",
                column: "StudySetId");
